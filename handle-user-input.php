<?php
	...
	if ($user_pushed == 1)
	{
		####################
		#
		# Brand X Escalation Path
		#
		####################
		echo '<Say>Brand X</Say>';
	    $ch = curl_init();
		$url = "https://myorg.pagerduty.com/api/v1/escalation_policies/PKPLMM6/on_call";
		...
		#echo '<Dial action="um-handle-first-call.php">';
	...
	{
		echo '<Say>All other services</Say>';
	    $ch = curl_init();
